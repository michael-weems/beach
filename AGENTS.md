...
Feature-specific documentation for the current edge-detection work lives under
`docs/edge_detection/`. Start with `docs/edge_detection/SUMMARY.md`, then
follow the read order in `docs/edge_detection/PROCEDURES.md`.
